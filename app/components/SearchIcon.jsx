const SearchIcon = ({ searchVlaue, iconLength, changeHandler }) => {
  return (
    <div className="flex items-center gap-6 bg-white border border-slate-200 shadow-xl shadow-slate-900/5 rounded-lg">
      ...
      <button className="flex-none text-sm px-4 py-3 mr-2 rounded text-slate-800 font-medium bg-slate-100 hover:bg-slate-200 ease-in-out duration-200 cursor-pointer">
        Download All Icons
      </button>
    </div>
  );
